...
### MAQUININHA_POS ###
SELECT id, id_empresa, descricao, administradora, cnpj FROM maquininhas_pos WHERE id = ?
`
...
SELECT id, id_empresa, descricao, administradora, cnpj FROM maquininhas_pos WHERE id_empresa = ?
`
...
SELECT id, id_empresa, descricao, administradora, cnpj FROM maquininhas_pos
`
